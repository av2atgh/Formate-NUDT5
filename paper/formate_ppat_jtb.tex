...
one-carbon availability: a theoretical prediction and its therapeutic implications}
...
protein kinase (AMPK). The same coupling operates in leukaemic stem cells, where
inhibiting mitochondrial one-carbon metabolism lowers purine nucleotide levels
and activates AMPK while suppressing mTORC1 \citep{zarou2024}. Their model
coupled formate to energy metabolism through
...
\bibitem[Zarou et al.(2024)]{zarou2024}
Zarou, M.M., Rattigan, K.M., Sarnello, D., et al., 2024. Inhibition of
mitochondrial folate metabolism drives differentiation through mTORC1-mediated
purine sensing. Nat. Commun. 15, 1931. doi:10.1038/s41467-024-46114-0.
